...
class Shader{
    ...
    void setModelViewProjectionMatrix(mat4 model=mat4(1.0),mat4 view = mat4(1.0),mat4 projection = mat4(1.0));
    ...
    //void updateModelViewProjectionMatrix(mat4 model,mat4 view,mat4 projection);
