...
Shader::Shader(ShaderData data)//:Shader(data)
{
    shaderProgram = loadShader(data.vs_path,data.fs_path);
}
Shader::Shader(string vertex_shader_path,string fragment_shader_path)//:Shader(vertex_shader_path,fragment_shader_path)
{
